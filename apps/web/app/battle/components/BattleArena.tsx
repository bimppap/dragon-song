...
function HpBar({ hp, max, color }: { hp: number; max: number; color: string }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="font-num w-24 shrink-0 text-right text-xs text-muted">
        {fmt(hp)} / {fmt(max)}
      </span>
    </div>
  );
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-bold text-ivory">{enemy.name} 전투 준비</h2>
          </div>
        ...
        <p className="text-sm text-muted">전투에 참여할 캐릭터를 선택하세요. 진영 구성에 따라 에너미 체력이 증가합니다.</p>
        ...
        {loading ? (
          <p className="text-sm text-muted">캐릭터 목록을 불러오는 중...</p>
        ) : (
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold text-ivory">{enemy.name} 전투</h2>
      ...
      {/* 에너미 */}
      <div className="rounded-xl border border-red-500/40 bg-red-500/15/40 p-4">
        ...
        {!result && (
          <div className="mt-3 flex flex-wrap items-center gap-2">
            <span className="text-xs font-semibold text-muted">에너미 행동</span>
            <Select
          ...
          return (
            <div
              ...
              className={cn(
                ...
                c.downed ? "border-line bg-primary-light/20 opacity-60" : "border-line bg-surface",
              )}
            >
              <div className="flex items-center justify-between gap-3">
