...
export const SPIRIT_STONE_CUSTOMIZE_GUIDE = {
  ...
  description: [
    "이제 보유한 정령석의 이름과 이미지, 설명을 직접 바꿀 수 있어요.",
    "",
    "1. 캐릭터 정보의 '보유 중인 아이템'에서 정령석에 커서를 올리세요. 장착 중인 정령석은 동반자·장신구 슬롯에 커서를 올리면 됩니다.",
    "2. 툴팁 아래의 '커스텀하기'를 누르세요.",
    "3. '이미지 바꾸기'로 이미지를 올리고, 이름과 설명을 입력한 뒤 '저장'을 누르세요.",
    "",
    "이름·설명을 비우면 원래 값으로, '원래 이미지로'를 누르면 원래 이미지로 돌아갑니다. 나중에 얻는 정령석도 같은 방법으로 커스텀할 수 있어요.",
  ].join("\n"),
